package huanglai.d9lab.study.modulelibrary.view;
...
import static huanglai.d9lab.study.modulelibrary.app.AppConstants.STATE_EMPTY;
import static huanglai.d9lab.study.modulelibrary.app.AppConstants.STATE_LOADING;
import static huanglai.d9lab.study.modulelibrary.app.AppConstants.STATE_SUCCESS;
...
public abstract class LoadingPage extends FrameLayout {
    ...
    public void showPage() {
        if (loadingView != null) {
            if (state == AppConstants.STATE_UNKNOWN || state == STATE_LOADING) {
        ...
        if (state == STATE_EMPTY || state == AppConstants.STATE_ERROR || state == STATE_SUCCESS) {
            // 关闭动画
            stopAnimation();
        }
