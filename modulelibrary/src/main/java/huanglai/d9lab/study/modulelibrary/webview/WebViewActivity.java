package huanglai.d9lab.study.modulelibrary.webview;
...
import huanglai.d9lab.study.modulelibrary.base.ui.BaseActivity;
...
//                        break;
//                }
                if (item.getItemId() == R.id.actionbar_share) {
                    String shareText = mWebChromeClient.getTitle() + mUrl + "（分享自" + R.string.app_name + "）";
                    ShareUtils.share(WebViewActivity.this, shareText);
                } else if (item.getItemId() == R.id.actionbar_cope) {
                    BaseTools.copy(mUrl);
                    ToastUtils.showShortToast("复制成功");
                } else if (item.getItemId() == R.id.actionbar_open) {
                    BaseTools.openLink(WebViewActivity.this, mUrl);
                } else {
